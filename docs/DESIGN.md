# Architecture Decision Record - SMS and email delivery status tracker
...
Implement SMS and email delivery status tracker using industry-standard patterns appropriate for nodejs and our platform requirements.
